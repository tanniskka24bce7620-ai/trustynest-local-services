...
const ChatMessageBubble = ({ msg, isMine, myLanguage, showOriginal, onToggleOriginal }: ChatMessageBubbleProps) => {
    ...
    <div className={cn("flex", isMine ? "justify-end" : "justify-start")}>
      <div className={cn(
        ...
        <div className="flex items-center gap-2 mt-1 flex-wrap">
          ...
          {/* TTS button for non-voice text messages too */}
